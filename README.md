...
Для демонстрации работы приложения доработан проект описания и тестирования REST API в Postman - доступен по следующей ссылке:
...
1. Настроить следующие переменные окружения, необходимые для корректной работы приложения:
...
2. Запустить docker-compose приложение:
```
docker compose -f "docker-compose.yaml" up -d --build 
```

3. После успешного запуска приложения (всех его контейнеров) приложение будет доступно на порту 8000 локального хоста.
